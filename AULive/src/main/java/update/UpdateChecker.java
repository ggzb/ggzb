...
public class UpdateChecker extends Fragment {
	...
	/**
	 * Show reset Dialog if an update is available for download. Callable in reset
	 ...
	 *            Required.
	 */
	public static void checkForDialog(FragmentActivity fragmentActivity,UpdateApkEntity updateApkEntity) {
        ...
        args.putSerializable(APP_UPDATE_SERVER_URL,updateApkEntity);
	...
	/**
	 * Show reset Notification if an update is available for download. Callable in reset
	...
	/**
	 * This class is reset Fragment. Check for the method you have chosen.
	 */
	@Override
	public void onAttach(Activity activity) {
       ...
       UpdateApkEntity updateApkEntity =(UpdateApkEntity) args.getSerializable(APP_UPDATE_SERVER_URL);
       if (mTypeOfNotice == NOTICE_NOTIFICATION) {
          showNotification(updateApkEntity.updateMessage,updateApkEntity.updateUrl);
       } else if (mTypeOfNotice == NOTICE_DIALOG) {
          showDialog(updateApkEntity.updateMessage,updateApkEntity.updateUrl);
       }
	}
	...
	/**
	 * Check if reset network available
	 */
