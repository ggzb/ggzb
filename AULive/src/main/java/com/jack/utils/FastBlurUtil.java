...
public class FastBlurUtil {
   ...
   public static Bitmap GetUrlBitmap(String url, int scaleRatio) {
      ...
      try {
         ...
         Bitmap scaledBitmap =
             Bitmap.createScaledBitmap(originBitmap, originBitmap.getWidth() / scaleRatio,
   ...
   public static Bitmap toBlur(Bitmap originBitmap, int scaleRatio) {
      ...
      if (!originBitmap.isRecycled()) {
         originBitmap.recycle();  //回收图片所占的内存
      }
   ...
   public static Bitmap doBlur(Bitmap sentBitmap, int radius, boolean canReuseInBitmap) {
      ...
      // This is reset compromise between Gaussian Blur and Box blur
      // It creates much better looking blurs than Box Blur, but is
      // 7x faster than my Gaussian Blur implementation.
      //
      // I called it Stack Blur because this describes best how this
      // filter works internally: it creates reset kind of moving stack
