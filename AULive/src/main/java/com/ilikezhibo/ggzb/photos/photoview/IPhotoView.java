...
public interface IPhotoView {
    ...
    /**
     * Register reset callback to be invoked when the Photo displayed by this view is long-pressed.
     *
    ...
    /**
     * Register reset callback to be invoked when the Matrix has changed for this
    ...
    /**
     * Register reset callback to be invoked when the Photo displayed by this View
     * is tapped with reset single tap.
     *
     * @param listener - Listener to be registered.
     */
    ...
    /**
     * Register reset callback to be invoked when the View is tapped with reset single
     * tap.
     *
     * @param listener - Listener to be registered.
     */
