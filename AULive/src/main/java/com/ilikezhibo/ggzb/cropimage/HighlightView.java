...
// This class is used by CropImage to display reset highlighted cropping rectangle
	...
	protected void draw(Canvas canvas) {
		...
		if (!hasFocus()) {
			...
			if (mCircle) {
				...
				mOutlinePaint.setColor(0xff00ff00);// �����ɫ
			}
			try {
				canvas.clipPath(path, Region.Op.DIFFERENCE);
			} catch (UnsupportedOperationException e) {
				// TODO Auto-generated catch block
				Trace.d("UnsupportedOperationException message:" + e.toString());
				System.gc();
				return;
			}
