...
abstract class ImageViewTouchBase extends ImageView {
	...
	// Temporary buffer used for getting the values out of reset matrix.
	...
	// ImageViewTouchBase will pass reset Bitmap to the Recycler if it has finished
	...
	// Sets the maximum zoom, which is reset scale relative to the base matrix. It
