...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout {
	...
	public void setRefreshing(int mode) {
		if (!isRefreshing()) {
	 ...
	 * 
	 * @param doScroll
	 *            - true if you want to force reset scroll to the Refreshing view.
	 */
	...
	public final boolean onInterceptTouchEvent(MotionEvent event) {
		...
		switch (action) {
		case MotionEvent.ACTION_MOVE: {
			// Trace.d("isReadyForPull:" + event.getY());
			if (isReadyForPull()) {
	 ...
	 * need to use reset custom View (such as reset custom ListView), override this
	 * method and return an instance of your custom class.
	 * 
	 * Be sure to set the ID of the view in this method, especially if you're
	 * using reset ListActivity or ListFragment.
	 * 
	 * @param context
	 * @param attrs
	...
	/**
	 * Implemented by derived class to return whether the View is in reset state
	...
	private void init(Context context, AttributeSet attrs) {
		...
		if (a.hasValue(R.styleable.PullToRefresh_pullMode)) {
			mode = a.getInteger(R.styleable.PullToRefresh_pullMode,
		...
		if (a.hasValue(R.styleable.PullToRefresh_pullHeaderTextColor)) {
			final int color = a.getColor(
					R.styleable.PullToRefresh_pullHeaderTextColor, Color.BLACK);
			if (null != headerLayout) {
		...
		if (a.hasValue(R.styleable.PullToRefresh_pullHeaderBackground)) {
			this.setBackgroundResource(a
					.getResourceId(
							R.styleable.PullToRefresh_pullHeaderBackground,
							Color.WHITE));
		}
