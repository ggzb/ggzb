...
public class TotalRecAdapter extends BaseAdapter{
    ...
    public TotalRecAdapter(Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //标签
        holder.txt_info.setText("收到 "+entity.getConsume_diamond()+"有美币");
        ...
        request.setCallback(new JsonCallback<BaseEntity>() {
            ...
            @Override public void onCallback(BaseEntity callback) {
                ...
                if (callback.getStat() == 200) {
                    ...
                    TotalRecAdapter.this.notifyDataSetChanged();
                } else {
