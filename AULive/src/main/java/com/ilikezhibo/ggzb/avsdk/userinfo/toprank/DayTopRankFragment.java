...
@SuppressLint("ValidFragment") public class DayTopRankFragment extends BaseFragment
    ...
    public DayTopRankFragment(String uid) {
        this.uid = uid;
    }
    ...
    @Override public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.msgInfoTv:
                Intent login_intent =
                        new Intent(DayTopRankFragment.this.getActivity(), LoginActivity.class);
    ...
    @Override public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        Intent homepage_Intent =
                new Intent(DayTopRankFragment.this.getActivity(), HomePageActivity.class);
        ...
        DayTopRankFragment.this.getActivity().startActivity(homepage_Intent);
    }
    ...
    @Override public void onRefresh(final int mode) {
        ...
        StringBuilder sb = new StringBuilder(
                UrlHelper.SERVER_URL + "live/dailyrank" + "?page=" + currPage + "&liveuid=" + uid);
        Trace.d(sb.toString());
        request = new RequestInformation(sb.toString(), RequestInformation.REQUEST_METHOD_GET);

        request.setCallback(new JsonCallback<TopRankDayEntity>() {

            @Override public void onCallback(TopRankDayEntity callback) {
                stopProgressDialog();
                if (callback == null) {
                    currPage--;
        ...
        }.setReturnType(TopRankDayEntity.class));
    ...
    private void showPromptDialog(final TopRankEntity qiuZuEntity) {
        final CustomDialog customDialog =
                new CustomDialog(DayTopRankFragment.this.getActivity(), new CustomDialogListener() {
