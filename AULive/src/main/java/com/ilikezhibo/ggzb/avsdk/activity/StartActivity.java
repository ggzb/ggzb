...
import com.ilikezhibo.ggzb.userinfo.MyUserInfoActivity;
...
public class StartActivity extends TabActivity implements View.OnClickListener {
   ...
   @Override public void onCreate(Bundle savedInstanceState) {
      ...
      //如果没登录，先登录
      if (!Utils.isLogin(StartActivity.this)) {
   ...
   private void initTabHost() {
      tabHost = getTabHost();
      Intent liveIntent = new Intent(this, com.ilikezhibo.ggzb.avsdk.home.ProgramListActivity.class);
      Intent centerIntent = new Intent(this, MyUserInfoActivity.class);
      tabHost.addTab(tabHost.newTabSpec("live").setIndicator("看直播").setContent(liveIntent));
      tabHost.addTab(tabHost.newTabSpec("center").setIndicator("个人中心").setContent(centerIntent));
   ...
   @Override public void onClick(View v) {
      switch (v.getId()) {
         ...
         case R.id.image_btn_show:
            startActivity(new Intent(StartActivity.this, ReleaseLiveActivity.class));
            break;
         default:
            break;
      }
