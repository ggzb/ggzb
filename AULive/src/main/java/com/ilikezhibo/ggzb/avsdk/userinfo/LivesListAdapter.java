...
public class LivesListAdapter extends BaseAdapter {
   ...
   @Override public View getView(final int position, View convertView, ViewGroup parent) {
      ...
      if (convertView == null || convertView.getTag() == null) {
         ...
         convertView = LayoutInflater.from(context).inflate(R.layout.cell_record_list_item, null);
         ...
         holder.record_time_tv = (TextView) convertView.findViewById(R.id.record_time_tv);
         holder.viewer_sum_tv = (TextView) convertView.findViewById(R.id.viewer_sum_tv);
      ...
      if (entity.getSex() == 1) {
         Bitmap bg_bitmap = ChatMsgListAdapter.readBitMap(context, R.drawable.global_male);
         holder.img_gender.setImageBitmap(bg_bitmap);
      } else {
         Bitmap bg_bitmap = ChatMsgListAdapter.readBitMap(context, R.drawable.global_female);
         holder.img_gender.setImageBitmap(bg_bitmap);
      }
      ...
      holder.txt_tip.setText(title);
      //holder.location_tv.setText(entity.getAddr());
      holder.viewer_sum_tv.setText(entity.visit_total);
      holder.record_time_tv.setText(entity.time);
      return convertView;
   }
