...
@SuppressLint("ValidFragment") public class TopRankFragment extends BaseFragment
   ...
   public TopRankFragment(String uid) {
      this.uid = uid;
   }
   ...
   @Override public void onClick(View v) {
      switch (v.getId()) {
         ...
         case R.id.msgInfoTv:
            Intent login_intent =
                new Intent(TopRankFragment.this.getActivity(), LoginActivity.class);
   ...
   @Override public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
      ...
      UserInfoHelper userInfoHelper =
          UserInfoHelper.getInstance(home_listview, popupWindow, this.getActivity(), memberInfo);

      //Intent homepage_Intent =
      //    new Intent(TopRankFragment.this.getActivity(), HomePageActivity.class);
      ...
      //TopRankFragment.this.getActivity().startActivity(homepage_Intent);
   }
   ...
   @Override public void onRefresh(final int mode) {
      ...
      StringBuilder sb =
          new StringBuilder(UrlHelper.ROOM_IN_GOLD_TOPS + "?page=" + currPage + "&liveuid=" + uid);
      Trace.d(sb.toString());
   ...
   private void doDelete(final TopRankEntity qiuZuEntity) {
      ...
      RequestInformation request = new RequestInformation(
          com.jack.utils.UrlHelper.URL_HEAD + "/friend/del?user=" + qiuZuEntity.getUid(),
   ...
   private void showPromptDialog(final TopRankEntity qiuZuEntity) {
      final CustomDialog customDialog =
          new CustomDialog(TopRankFragment.this.getActivity(), new CustomDialogListener() {
