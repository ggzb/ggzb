...
@SuppressLint("ValidFragment") public class AttenListFragment extends BaseFragment
   ...
   public AttenListFragment(String uid) {
      this.uid = uid;
      is_use_in_homepage=true;
   }

   //public static String MemberInfo_key = "MemberInfo_key";
   //public static final AttenListFragment newInstance(String uid) {
   //   AttenListFragment f = new AttenListFragment();
   ...
   @Override public void onClick(View v) {
      switch (v.getId()) {
         ...
         case R.id.msgInfoTv:
            Intent login_intent =
                new Intent(AttenListFragment.this.getActivity(), LoginActivity.class);
   ...
   @Override public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
      ...
      Intent homepage_Intent =
          new Intent(AttenListFragment.this.getActivity(), HomePageActivity.class);
      homepage_Intent.putExtra(HomePageActivity.HOMEPAGE_UID, entity.getUid());
      AttenListFragment.this.getActivity().startActivity(homepage_Intent);
   ...
   @Override public void onRefresh(final int mode) {
      ...
      StringBuilder sb =
          new StringBuilder(UrlHelper.ROOM_ATTEN + "?page=" + currPage + "&liveuid=" + uid);
      Trace.d(sb.toString());
   ...
   private void showPromptDialog(final TopRankEntity qiuZuEntity) {
      final CustomDialog customDialog =
          new CustomDialog(AttenListFragment.this.getActivity(), new CustomDialogListener() {
