 ...
 * 
 */
public class FaXiangMuStep2Adapter extends BaseAdapter {
	...
	public FaXiangMuStep2Adapter(Context context) {
		...
		if (entities.size() > index) {
			...
			holder.layout_one.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View view) {
					...
					if (select_count >= 0 && select_count < 100 || checked) {
						if (checked) {
							select_count--;
						} else {
							select_count++;
						...
						FaXiangMuStep2Adapter.this.notifyDataSetChanged();
					} else {
				...
				if (second_entity.isEmpty() == true) {
					...
					holder.layout_two.setOnClickListener(new OnClickListener() {
						...
						public void onClick(View view) {
							...
							if (select_count >= 0 && select_count < 100
									|| checked) {
								if (checked) {
									select_count--;
								} else {
