...
public class ShiHuoStep1Fragment extends BaseFragment implements
	...
	public ShiHuoStep1Fragment(String m_url) {
		url = m_url;
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		back_home = this.getActivity().getIntent()
				.getBooleanExtra(MyProFileActivity.back_home_key, false);
		...
		View listHeadView = LayoutInflater.from(this.getActivity()).inflate(
				R.layout.step1_first_listitem, null);
	...
	public void onResume() {
		...
		fenLeiAdapter = new FenLeiAdapter(this.getActivity());
	...
	public void onClick(View v) {
		...
		case R.id.topRightBtn:
			...
			Intent intent = new Intent(ShiHuoStep1Fragment.this.getActivity(),
					ShiHuoStep2Activity.class);
			intent.putExtra(SHIHUOSTEP_JOBS_TYPE, temp);
			intent.putExtra(MyProFileActivity.back_home_key, back_home);
			startActivity(intent);

			if (back_home) {
				ShiHuoStep1Fragment.this.getActivity().finish();
			}
			break;
		case R.id.reg_bt:
