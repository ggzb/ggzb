...
public class MyFavProjectFragment extends BaseFragment implements
	...
	public void onClick(View v) {
		...
		case R.id.msgInfoTv:
			Intent login_intent = new Intent(
					MyFavProjectFragment.this.getActivity(),
					LoginActivity.class);
	...
	public void onRefresh(final int mode) {
		...
		StringBuilder sb = new StringBuilder(UrlHelper.URL_HEAD
				+ "/apply/my_follower_lists?page=" + currPage);
		Trace.d(sb.toString());
