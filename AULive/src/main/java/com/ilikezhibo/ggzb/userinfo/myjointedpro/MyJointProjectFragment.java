...
public class MyJointProjectFragment extends BaseFragment implements
	...
	public void onClick(View v) {
		...
		case R.id.msgInfoTv:
			Intent login_intent = new Intent(
					MyJointProjectFragment.this.getActivity(),
					LoginActivity.class);
