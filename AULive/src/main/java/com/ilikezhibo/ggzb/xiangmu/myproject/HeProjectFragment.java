...
public class HeProjectFragment extends BaseFragment implements OnClickListener,
	...
	public HeProjectFragment(String uid1) {
		uid = uid1;
	}
	...
	public void onClick(View v) {
		...
		case R.id.msgInfoTv:
			Intent login_intent = new Intent(
					HeProjectFragment.this.getActivity(), LoginActivity.class);
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,
		...
		Intent authorIntent = new Intent(HeProjectFragment.this.getActivity(),
	...
	public void onRefresh(final int mode) {
		...
		StringBuilder sb = new StringBuilder(UrlHelper.URL_HEAD
				+ "/project/other_list?page=" + currPage + "&uid=" + uid);
		Trace.d(sb.toString());
			...
			public void onCallback(XiangMuListEntity callback) {
				...
				if (callback.getStat() == 200) {
					...
					if (callback.getStat() == 500 && has_ask_login == false) {
						has_ask_login = true;
						Intent login_intent = new Intent(HeProjectFragment.this
	...
	private void showPromptDialog(final XiangMuEntity qiuZuEntity) {
		final CustomDialog customDialog = new CustomDialog(
				HeProjectFragment.this.getActivity(),
