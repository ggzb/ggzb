...
public class MyProjectFragment extends BaseFragment implements OnClickListener,
	...
	public void onClick(View v) {
		...
		case R.id.msgInfoTv:
			Intent login_intent = new Intent(
					MyProjectFragment.this.getActivity(), LoginActivity.class);
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,
		...
		Intent authorIntent = new Intent(MyProjectFragment.this.getActivity(),
			...
			public void onCallback(XiangMuListEntity callback) {
				...
				if (callback.getStat() == 200) {
					...
					if (callback.getStat() == 500 && has_ask_login == false) {
						has_ask_login = true;
						Intent login_intent = new Intent(MyProjectFragment.this
