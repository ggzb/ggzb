...
public class HeartLayout extends RelativeLayout {
   ...
   public void addHeart(int color) {
      FeatherView heartView = new FeatherView(getContext());
   ...
   public static int[] pics_other = {
       R.drawable.wedding_dress_weather1, R.drawable.wedding_dress_weather2,
       R.drawable.wedding_dress_weather3, R.drawable.wedding_dress_weather4,
       R.drawable.wedding_dress_weather5, R.drawable.wedding_dress_weather6
   };
   ...
   public void addHeart2(int ResourceId) {
      ...
      Trace.d("Feather Drops addHeart2");
      //方法1
