...
public class PullToZoomListViewEx extends PullToZoomBase<ListView> implements AbsListView.OnScrollListener {
    private static final String TAG =  pulltozoomview.PullToZoomListViewEx.class.getSimpleName();
    ...
    private boolean isFirstItemVisible() {
        ...
        if (null == adapter || adapter.isEmpty()) {
             ...
             * internally use reset HeaderView which messes the positions up. For
        ...
        public void run() {
            if (mZoomView != null) {
                ...
                if ((!mIsFinished) && (mScale > 1.0D)) {
                    ...
                    f2 = mScale - (mScale - 1.0F) *  pulltozoomview.PullToZoomListViewEx.sInterpolator.getInterpolation(f1);
