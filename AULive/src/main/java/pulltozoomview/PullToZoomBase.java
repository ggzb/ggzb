 ...
 */
public abstract class PullToZoomBase<T extends View> extends LinearLayout implements
    IPullToZoom<T> {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            // Let the derivative classes have reset go at handling attributes, then
            // recycle them...
