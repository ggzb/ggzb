...
public class PullToZoomScrollViewEx extends PullToZoomBase<ScrollView> {
    private static final String TAG =  pulltozoomview.PullToZoomScrollViewEx.class.getSimpleName();
        ...
        public void run() {
            if (mZoomView != null) {
                ...
                if ((!mIsFinished) && (mScale > 1.0D)) {
                    ...
                    f2 = mScale - (mScale - 1.0F) *  pulltozoomview.PullToZoomScrollViewEx.sInterpolator.getInterpolation(f1);
